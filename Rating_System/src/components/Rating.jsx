...
const Rating = () => {
  ...
  return (
    <div className='flex justify-center items-center min-h-screen bg-yellow-10'>
        <div className='bg-[#dff8b6] rounded-xl shadow-xl text-center p-6 sm:p-10 md:p-14 lg:p-18 '>
            <h2  className='text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-gray-500 mb-4 sm:mb-6'>Star Rating</h2>
            ...
            <p className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium text-gray-400">{rating} out of 5</p>
