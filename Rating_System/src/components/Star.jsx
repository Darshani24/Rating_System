...
const Star = ({index,rating,onRatingChange}) => {
  ...
  return (
    <div className="relative">
        <i className={`bx  ${starClass} text-5xl sm:text-7xl md:text-8xl lg:text-9xl text-yellow-400`}
       
        ></i>

        <button className="absolute top-0 left-0 w-1/2 h-full cursor-pointe" onClick={handleLeftClick}/>
